...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 26 | N/A | <1ms | - | - | - | - | - |
| Smart | 26 | :white_check_mark: | 5ms | 30 | 18 | 12 | 7 | - |
| Simple | 26 | :white_check_mark: | 2ms | 32 | 25 | 7 | 19 | - |
...
| Simple | 8 | :white_check_mark: | 3ms | 56 | 43 | 13 | 31 | - |
| Concorde | 8 | :white_check_mark: | 1ms | - | - | - | - | - |
...
| Concorde | 136 | :white_check_mark: | 1ms | - | - | - | - | - |
...
| Concorde | 88 | :white_check_mark: | 1ms | - | - | - | - | - |
...
| Simple | 74 | :white_check_mark: | 4ms | 103 | 74 | 29 | 46 | - |
...
| Concorde | 51 | :white_check_mark: | 1ms | - | - | - | - | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 64 | N/A | 2ms | - | - | - | - | - |
| Smart | 64 | :white_check_mark: | 2ms | 44 | 27 | 17 | 11 | - |
| Simple | 64 | :white_check_mark: | 15ms | 310 | 208 | 102 | 107 | - |
...
| Simple | 73 | :white_check_mark: | 10ms | 203 | 136 | 67 | 70 | - |
...
| Concorde | 93 | :white_check_mark: | 2ms | - | - | - | - | - |
...
| Simple | 86 | :white_check_mark: | 3ms | 31 | 21 | 10 | 12 | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 100 | N/A | <1ms | - | - | - | - | - |
| Smart | 100 | :white_check_mark: | 3ms | 49 | 36 | 13 | 24 | - |
| Simple | 100 | :white_check_mark: | 3ms | 83 | 68 | 15 | 54 | - |
...
| Simple | 199 | :white_check_mark: | 3ms | 87 | 69 | 18 | 52 | - |
...
|-----------|--------|---------|-------|------------|------------|----------|---------------|-----------------|
| Smart | 19 | 0 | 0 | 0 | 85ms | 4ms | 30 | 578 |
| Simple | 19 | 0 | 0 | 0 | 112ms | 6ms | 124 | 2355 |
| Concorde | 19 | 0 | 0 | 0 | 44ms | 2ms | 0 | 0 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | `examples/five-city.txt` | 5 | 26 | 26 | 26 | 26 | <1ms | 5ms | 2ms | 3ms |
| 2 | `examples/converted/five-node-euc.txt` | 5 | 8 | 8 | 8 | 8 | <1ms | 4ms | 3ms | 1ms |
| 3 | `examples/converted/five-node-explicit.txt` | 5 | 26 | 26 | 26 | 26 | <1ms | 4ms | 2ms | 2ms |
| 4 | `examples/random/complete/rnd-01-complete-n4.txt` | 4 | 45 | 45 | 45 | 45 | <1ms | 4ms | 4ms | 3ms |
| 5 | `examples/random/complete/rnd-02-complete-n5.txt` | 5 | 136 | 136 | 136 | 136 | <1ms | 4ms | 4ms | 1ms |
| 6 | `examples/random/complete/rnd-03-complete-n4.txt` | 4 | 102 | 102 | 102 | 102 | <1ms | 4ms | 4ms | 2ms |
| 7 | `examples/random/complete/rnd-04-complete-n5.txt` | 5 | 88 | 88 | 88 | 88 | <1ms | 4ms | 4ms | 1ms |
| 8 | `examples/random/complete/rnd-05-complete-n7.txt` | 7 | 74 | 74 | 74 | 74 | <1ms | 5ms | 4ms | 3ms |
| 9 | `examples/random/complete/rnd-06-complete-n5.txt` | 5 | 51 | 51 | 51 | 51 | <1ms | 4ms | 4ms | 1ms |
| 10 | `examples/random/complete/rnd-07-complete-n8.txt` | 8 | 64 | 64 | 64 | 64 | 2ms | 2ms | 15ms | 3ms |
| 11 | `examples/random/complete/rnd-08-complete-n7.txt` | 7 | 73 | 73 | 73 | 73 | <1ms | 5ms | 10ms | 3ms |
| 12 | `examples/random/complete/rnd-09-complete-n8.txt` | 8 | 93 | 93 | 93 | 93 | 2ms | 11ms | 30ms | 2ms |
| 13 | `examples/random/complete/rnd-10-complete-n7.txt` | 7 | 49 | 49 | 49 | 49 | <1ms | 5ms | 7ms | 3ms |
| 14 | `examples/random/sparse/rnd-01-sparse-n5.txt` | 5 | 110 | 110 | 110 | 110 | <1ms | 4ms | 4ms | 3ms |
| 15 | `examples/random/sparse/rnd-02-sparse-n7.txt` | 7 | 196 | 196 | 196 | 196 | <1ms | 5ms | 3ms | 3ms |
| 16 | `examples/random/sparse/rnd-03-sparse-n7.txt` | 7 | 86 | 86 | 86 | 86 | <1ms | 4ms | 3ms | 2ms |
| 17 | `examples/random/sparse/rnd-04-sparse-n6.txt` | 6 | 115 | 115 | 115 | 115 | <1ms | 3ms | 4ms | 2ms |
| 18 | `examples/random/sparse/rnd-05-sparse-n6.txt` | 6 | 100 | 100 | 100 | 100 | <1ms | 3ms | 3ms | 2ms |
| 19 | `examples/random/sparse/rnd-06-sparse-n7.txt` | 7 | 199 | 199 | 199 | 199 | <1ms | 5ms | 3ms | 2ms |
