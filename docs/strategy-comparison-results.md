...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 45 | N/A | <1ms | - | - | - | - | - |
| Smart | 45 | :white_check_mark: | 4ms | 6 | 3 | 3 | 1 | - |
| Simple | 45 | :white_check_mark: | 4ms | 13 | 9 | 4 | 6 | - |
...
| Simple | 26 | :white_check_mark: | 5ms | 32 | 25 | 7 | 19 | - |
...
| Simple | 8 | :white_check_mark: | 5ms | 56 | 43 | 13 | 31 | - |
| Concorde | 8 | :white_check_mark: | 2ms | - | - | - | - | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 26 | N/A | <1ms | - | - | - | - | - |
| Smart | 26 | :white_check_mark: | 2ms | 30 | 18 | 12 | 7 | - |
| Simple | 26 | :white_check_mark: | 4ms | 32 | 25 | 7 | 19 | - |
| Concorde | 26 | :white_check_mark: | 2ms | - | - | - | - | - |
...
| Simple | 136 | :white_check_mark: | 4ms | 35 | 26 | 9 | 18 | - |
| Concorde | 136 | :white_check_mark: | 2ms | - | - | - | - | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 88 | N/A | <1ms | - | - | - | - | - |
| Smart | 88 | :white_check_mark: | 4ms | 11 | 6 | 5 | 2 | - |
| Simple | 88 | :white_check_mark: | 4ms | 24 | 15 | 9 | 7 | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 51 | N/A | <1ms | - | - | - | - | - |
| Smart | 51 | :white_check_mark: | 4ms | 11 | 6 | 5 | 2 | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 196 | N/A | <1ms | - | - | - | - | - |
| Smart | 196 | :white_check_mark: | 5ms | 32 | 22 | 10 | 13 | - |
| Simple | 196 | :white_check_mark: | 6ms | 92 | 71 | 21 | 51 | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 86 | N/A | <1ms | - | - | - | - | - |
| Smart | 86 | :white_check_mark: | 2ms | 11 | 7 | 4 | 4 | - |
| Simple | 86 | :white_check_mark: | 4ms | 31 | 21 | 10 | 12 | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 74 | N/A | <1ms | - | - | - | - | - |
| Smart | 74 | :white_check_mark: | 5ms | 42 | 25 | 17 | 9 | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 49 | N/A | <1ms | - | - | - | - | - |
| Smart | 49 | :white_check_mark: | 4ms | 22 | 13 | 9 | 5 | - |
| Simple | 49 | :white_check_mark: | 4ms | 106 | 68 | 38 | 31 | - |
...
| Simple | 64 | :white_check_mark: | 13ms | 310 | 208 | 102 | 107 | - |
...
|-----------|------|----------|------|---------------|----------------|---------------|----------------|---------|
| DP | 93 | N/A | 2ms | - | - | - | - | - |
| Smart | 93 | :white_check_mark: | 11ms | 173 | 111 | 62 | 50 | - |
| Simple | 93 | :white_check_mark: | 28ms | 1113 | 769 | 344 | 426 | - |
...
|-----------|--------|---------|-------|------------|------------|----------|---------------|-----------------|
| Smart | 20 | 0 | 0 | 0 | 86ms | 4ms | 30 | 608 |
| Simple | 20 | 0 | 0 | 0 | 128ms | 6ms | 119 | 2387 |
| Concorde | 20 | 0 | 0 | 0 | 48ms | 2ms | 0 | 0 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | `examples/random/complete/rnd-01-complete-n4.txt` | 4 | 45 | 45 | 45 | 45 | <1ms | 4ms | 4ms | 2ms |
| 2 | `examples/random/complete/rnd-03-complete-n4.txt` | 4 | 102 | 102 | 102 | 102 | <1ms | 4ms | 4ms | 2ms |
| 3 | `examples/five-city.tsp` | 5 | 26 | 26 | 26 | 26 | <1ms | 4ms | 5ms | 2ms |
| 4 | `examples/five-city.txt` | 5 | 26 | 26 | 26 | 26 | <1ms | 4ms | 4ms | 2ms |
| 5 | `examples/converted/five-node-euc.txt` | 5 | 8 | 8 | 8 | 8 | <1ms | 4ms | 5ms | 2ms |
| 6 | `examples/converted/five-node-explicit.txt` | 5 | 26 | 26 | 26 | 26 | <1ms | 2ms | 4ms | 2ms |
| 7 | `examples/random/sparse/rnd-01-sparse-n5.txt` | 5 | 110 | 110 | 110 | 110 | <1ms | 4ms | 4ms | 2ms |
| 8 | `examples/random/complete/rnd-02-complete-n5.txt` | 5 | 136 | 136 | 136 | 136 | <1ms | 4ms | 4ms | 2ms |
| 9 | `examples/random/complete/rnd-04-complete-n5.txt` | 5 | 88 | 88 | 88 | 88 | <1ms | 4ms | 4ms | 2ms |
| 10 | `examples/random/complete/rnd-06-complete-n5.txt` | 5 | 51 | 51 | 51 | 51 | <1ms | 4ms | 4ms | 2ms |
| 11 | `examples/random/sparse/rnd-04-sparse-n6.txt` | 6 | 115 | 115 | 115 | 115 | <1ms | 2ms | 3ms | 2ms |
| 12 | `examples/random/sparse/rnd-05-sparse-n6.txt` | 6 | 100 | 100 | 100 | 100 | <1ms | 5ms | 6ms | 2ms |
| 13 | `examples/random/sparse/rnd-02-sparse-n7.txt` | 7 | 196 | 196 | 196 | 196 | <1ms | 5ms | 6ms | 2ms |
| 14 | `examples/random/sparse/rnd-03-sparse-n7.txt` | 7 | 86 | 86 | 86 | 86 | <1ms | 2ms | 4ms | 2ms |
| 15 | `examples/random/complete/rnd-05-complete-n7.txt` | 7 | 74 | 74 | 74 | 74 | <1ms | 5ms | 7ms | 3ms |
| 16 | `examples/random/sparse/rnd-06-sparse-n7.txt` | 7 | 199 | 199 | 199 | 199 | <1ms | 5ms | 6ms | 2ms |
| 17 | `examples/random/complete/rnd-08-complete-n7.txt` | 7 | 73 | 73 | 73 | 73 | <1ms | 5ms | 9ms | 3ms |
| 18 | `examples/random/complete/rnd-10-complete-n7.txt` | 7 | 49 | 49 | 49 | 49 | <1ms | 4ms | 4ms | 3ms |
| 19 | `examples/random/complete/rnd-07-complete-n8.txt` | 8 | 64 | 64 | 64 | 64 | 2ms | 5ms | 13ms | 3ms |
| 20 | `examples/random/complete/rnd-09-complete-n8.txt` | 8 | 93 | 93 | 93 | 93 | 2ms | 11ms | 28ms | 3ms |
