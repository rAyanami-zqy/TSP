...
private:
    ...
    // 对根 1-tree 的树边做 forbid sensitivity；若禁用某边后的最小
    // 1-tree 已无法改善 incumbent，则该边可永久固定为 x_e=1。
    RootTreeFixingStats applyRootTreeEdgeFixing(
